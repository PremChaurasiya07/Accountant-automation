...
export default function SellerCard() {
  ...
  return (
    <DashboardLayout>
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 gap-8 lg:flex-row lg:items-start font-sans">
        ...
        <div className="flex flex-col items-center w-full max-w-lg">
          ...
          >
            ...
            >
              {/* FRONT */}
              <div className="absolute inset-0 rounded-2xl bg-[#1C1C1E] text-white shadow-2xl p-4 sm:p-6 md:p-8 flex flex-col justify-between backface-hidden overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 sm:gap-5">
                    {seller.logo_url && (
                      <img src={seller.logo_url} alt="Logo" className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 object-contain rounded-lg" />
                    )}
                    <div>
              ...
              {/* BACK */}
              <div className="absolute inset-0 rounded-2xl bg-[#1C1C1E] text-white shadow-2xl p-4 sm:p-6 md:p-8 flex items-center justify-between [transform:rotateY(180deg)] backface-hidden overflow-hidden">
                 <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%23ffffff%22%20fill-opacity%3D%220.04%22%3E%3Cpath%20d%3D%22M36%2034v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6%2034v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6%204V0H4v4H0v2h4v4h2V6h4V4H6z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"></div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
            <button onClick={handleCopyLink} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white shadow border font-semibold hover:bg-gray-200 transition-colors text-sm sm:text-base"><LinkIcon size={16} /> Copy Link</button>
            <button onClick={handleDownloadPDF} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white shadow border font-semibold hover:bg-gray-200 transition-colors text-sm sm:text-base"><Download size={16} /> Download PDF</button>

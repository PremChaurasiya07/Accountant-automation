...
const PhoneMockup = ({ activeImage }) => {
    return (
        <div className="relative w-full max-w-[185px] md:max-w-[280px] aspect-[9/19] bg-black border-4 border-gray-700 rounded-[2.8rem] shadow-2xl shadow-black/60 p-2 pointer-events-auto">
